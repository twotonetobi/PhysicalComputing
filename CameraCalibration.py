...
adopted Tutorial Example from openCV Documentation
...
####
# change image path according to your file location.
####
...
####
# save matrices. change save path according to your file location.
####
np.savez('B.npz', None, mtx=mtx,
...
plt.subplot(122), plt.imshow(dst), plt.title(
    'Undistort'), plt.xticks([]), plt.yticks([])
plt.show()
...
#     objpoints, imgpoints, gray.shape[::-1], None, None)
# # save matrices
# np.savez('../../img/calib/B.npz', None, mtx=mtx,
#          dist=dist, rvecs=rvecs, tvecs=tvecs)
# # Undistortion
